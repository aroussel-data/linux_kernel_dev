/* **************** LFD420:6.10 s_10/lab_syscall_module.c ****************
 ...
 *
 *  (Insert the proper full or relative path to the patch as needed.)
 *
...
MODULE_DESCRIPTION("LFD420:6.10 s_10/lab_syscall_module.c");
